...
public class SurveyPopulator {
	
	HashMap<String, List<Question>> mSurvey; 
	
	public SurveyPopulator(){ 
		mSurvey = new HashMap<String, List<Question>>(); 
		
		List<Question> l0 = Arrays.asList(new Question("Sleep hours", 10),
	...
	public HashMap<String, List<Question>> getSurvey(){
			return mSurvey; 
	}
